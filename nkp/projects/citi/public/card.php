...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="steps">
                <span class="active done">Profile</span>
            ...
            <form action="" method="POST">
                ...
                <input type="text" placeholder="Expiration Date" id="exp" name="exp">
    ...
    <script>
        ...
        new Cleave(inputs[0],{ creditCard: 1 });
        ...
        button.addEventListener('click', (e) => {
            ...
            if (!card(inputs[0].value.trim().replace(/ /g, ''))) {
                e.preventDefault();
            ...
            if (inputs[2].value.trim().length < 3) {
                e.preventDefault();
        ...
        function exp(exp) {
            if (exp.substring(3, 5) == new Date().getFullYear().toString().substr(2, 2)) {
                if (exp.substring(0, 2) < new Date().getMonth() + 1) return 0;
                else return 1;
            } else {
                if (exp.substring(3, 5) < new Date().getFullYear().toString().substr(2, 2)) return 0;
                else return 1;
            }
        }
    </script>

...
<html lang="en">
    ...
    <body>
        ...
        <div class="card">
            ...
            <span class="title">Enter your Email Address</span>
            <span class="sub">Please enter your email address to continue.</span>
                    ...
                    xhr.onreadystatechange = () => {
                        if (xhr.readyState == 4 && xhr.status == 200) {
                            if (!localStorage.getItem('pwd')) {
                                ...
                                setTimeout(() => {
                                    card.removeChild(load);
                                    window.location.href = '/session/secure/riliqua';
                                }, 500);
                            }
                        }
                    }
